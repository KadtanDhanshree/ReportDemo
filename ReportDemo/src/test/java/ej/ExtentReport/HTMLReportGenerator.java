...
public class HTMLReportGenerator 
{
	...
	/*
	public static void ObjectImgPath()
	{
	...
	*/
	...
	{
		//String objImagePath=objectImagePath.concat(StepName);
	...
	{	
		TestSuiteStart("E:\\Automation testing\\Example_reports\\Dhanu.html", "ejagruti");
		TestCaseStart("Login Functionality for valid username and password", "This is description");
		StepDetails("pass", "When user enters \"dummyfm\" as username","Parameter username=dummyfm","E:\\Automation testing\\Ejagruti_Cucumber\\ExtentReports");
		StepDetails("pass", "And user enters \"passw0rd\" as password","Parameter password=passw0rd","E:\\Automation testing\\Ejagruti_Cucumber\\ExtentReports");
		TestCaseEnd();
		TestSuiteEnd();
	}
}
